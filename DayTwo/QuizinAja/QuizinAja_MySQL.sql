...
VALUES
    (1, 'History Quiz', 'HIST101', 'Test your knowledge of historical events and figures.', NOW(3)),
    (2, 'Science Quiz', 'SCI202', 'Explore the wonders of the natural world with this science quiz.', NOW(3)),
    (3, 'Math Challenge', 'MATH123', 'A math quiz that will put your problem-solving skills to the test.', NOW(3)),
    (4, 'Literature Quiz', 'LIT202', 'Test your knowledge of classic literature and authors.', NOW(3)),
    (5, 'Geography Quiz', 'GEOG101', 'Discover the world through this geography quiz.', NOW(3)),
    (6, 'Music Trivia', 'MUSIC303', 'A fun quiz for music enthusiasts to test their knowledge.', NOW(3)),
    (7, 'Movie Buff Quiz', 'FILM101', 'Test your knowledge of popular movies and actors.', NOW(3)),
    (8, 'Language Quiz', 'LANG456', 'Challenge your language skills with this quiz.', NOW(3)),
    (9, 'Art and Culture Quiz', 'ART101', 'Explore the world of art and culture in this quiz.', NOW(3)),
    (10, 'Sports Quiz', 'SPORTS202', 'Test your sports knowledge with this exciting quiz.', NOW(3));
...
INSERT INTO `Participant` (`QuizID`, `ParticipantNickname`, `ParticipationDate`, `TimeTaken`) VALUES (1, 'Andi123', NOW(3), 124);
...
INSERT INTO `Participant` (`QuizID`, `ParticipantNickname`, `ParticipationDate`, `TimeTaken`) VALUES (1, 'Budi321', NOW(3), 55);
...
VALUES
    (1, 'Emma246', NOW(3), 85),
    (1, 'James369', NOW(3), 72),
    (1, 'Sophia481', NOW(3), 93),
    (1, 'William602', NOW(3), 78);
